...
<table class="auto-style1" runat="server" id="FormTable">
    <tr>
        <td colspan="3"><h1>Get in touch with us</h1><br />
            Use the form below to get in touch with us.&nbsp; Enter your name, email address, and your home or business phone number to get in touch with us.</td>
    </tr>
    <tr>
        <td>Name&nbsp;</td>
        <td>
