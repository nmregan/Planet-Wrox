    ...
    protected void btnSendButton_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            try
            {
                ...
                myMessage.From = new MailAddress(CAppConfiguration.FromAddress, CAppConfiguration.FromName);
                myMessage.To.Add(new MailAddress(CAppConfiguration.ToAddress, CAppConfiguration.ToName)); 
